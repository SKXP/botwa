...
/////////////////
const BotName = 'XP BOT☄'; 
const instagram = 'https://instagram.com/skxp_gg'; 
const telegram = 'https://t.me'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/channel/UCKnxrWkbr1lrQnzzKo_400w';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@skxp_gg')
